...
public class RSAUtil {
    ...
    public static String encrypt(String password) throws Exception {
        ...
        PublicKey publicKey = KeyFactory.getInstance("RSA")
                .generatePublic(new X509EncodedKeySpec(getDecoder().decode(publicKeyBase64)));
        ...
        return getEncoder().encodeToString(encryptedBytes).replace("+","_");
    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        PrivateKey privateKey = KeyFactory.getInstance("RSA")
                .generatePrivate(new PKCS8EncodedKeySpec(getDecoder().decode(privateKeyBase64)));
        ...
        byte[] encryptedBytes = encryptCipher.doFinal(password.getBytes());
        //密文作为参数传输到后端时+号变成了空格，"+"替换成"_"
        String result = getEncoder().encodeToString(encryptedBytes).replace("+","_");
